    ...
    >
      <div className="flex flex-col md:flex-row items-center gap-12">
        ...
        >
          ...
          >
            Link With Your Academic Profiles
          </motion.h2>
          <motion.p 
            variants={fadeIn('up', 0.6)}
            className="text-gray-600 mb-8 md:w-4/5"
          >
            Show your Publications and Researches automatically by link your website with your Academic Profiles like Google Scholar
          </motion.p>
          <motion.a 
