  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center px-4">
      <div className="max-w-3xl w-full text-center space-y-6">
        <h1 className="text-4xl font-bold text-gray-800">Start Building Your Academic Website</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          ...
          >
            <h2 className="text-2xl font-semibold text-blue-600 mb-2">Use AI Assistant 🤖</h2>
            <p className="text-gray-600">Let AI help you build your website based on your answers and profile.</p>
          </div>
          ...
          >
            <h2 className="text-2xl font-semibold text-green-600 mb-2">Choose a Template 📁</h2>
            <p className="text-gray-600">Pick from a variety of ready-made templates to get started quickly.</p>
          </div>
        </div>
      </div>
    </div>
